// app/coaching-barberia/page.tsx
"use client";
...
const WHATSAPP = "https://wa.me/16452234957?text=Hola%20Gast%C3%B3n%2C%20quiero%20el%20diagn%C3%B3stico%20de%2015%20min%20para%20el%20coaching%20de%20barber%C3%ADa.";
const BOOKING_ANCHOR = "#booksy"; // cámbialo si usás otro scheduler
  ...
  return (
    <main className="min-h-screen pb-28">
      ...
      <section className="mx-auto max-w-[1100px] px-4 mt-16 grid gap-6 lg:grid-cols-3">
        <Card title="Semana 0">
          Diagnóstico y línea base de KPIs.
        </Card>
      ...
      <div className="mt-4">
        <a
          ...
          className={`w-full inline-flex justify-center px-4 py-2 rounded-xl font-semibold ${
            highlight ? "bg-blue-500 hover:bg-blue-400" : "bg-white text-black hover:bg-blue-100"
          }`}
        >
          {cta}
        </a>
